...
with top_left_column:
    ...
    with column_1:
        ...
        plot_gauge(eu_ets_pernm, "#0068C9", " €", "EU ETS per NM", 100)
    ...
    with column_2:
        ...
        plot_gauge(eu_penalty_pernm, "#FF8700", " €", "Fuel EU per NM", 50)

    with column_3:
        plot_metric("Distance", total_distance, prefix="", suffix=" NM", show_graph=False)
        plot_gauge(total_eu_cost_pernm, "#FF2B2B", " €", "EU Penalty", 90)
